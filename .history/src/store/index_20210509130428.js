  ...
  mutations: {
    ...
    comprar(state) {
      ...
      if (respuesta) {
        ...
        const sumVenta = state.ventas.forEach ((piz) => {
          const obj3 = {
            precioSubtotal: piz.subtotal,
            cantidadVendida: piz.cantidad,
          }
          
          state.ventas.push(piz);
          return obj3;
         
        });
         
        state.ventas = state.ventas.push(sumVenta);
